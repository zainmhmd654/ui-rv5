...
["Color Dark Text"] = Color3.fromRGB(200, 200, 200) 
		...
		Red = {
["Color Hub 1"] = ColorSequence.new({
    ColorSequenceKeypoint.new(0.00, Color3.fromRGB(100, 0, 0)),   -- البداية: أحمر غامق
    ColorSequenceKeypoint.new(0.50, Color3.fromRGB(150, 0, 0)),  -- النص: أحمر أفتح شوي
    ColorSequenceKeypoint.new(1.00, Color3.fromRGB(100, 0, 0))   -- النهاية: نفس البداية (أحمر غامق)
			}),
